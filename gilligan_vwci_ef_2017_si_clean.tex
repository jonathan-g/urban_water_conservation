...
\begin{figure}
\includegraphics[width=6.25in]{figures_si_clean/vwci_pvi_cat_plots-1} \caption[Regression coefficients for VWCI, with different covariates]{Regression coefficients for VWCI, with different covariates.}\label{fig:vwci_pvi_cat_plots}
\end{figure}
